...
class CommonApi
{
     ...
     *
     * @param  string $query Search criteria (required)
     *
    ...
    {
        $returnType = 'object';
        $request = $this->searchGetRequest($query);
     ...
     */
    public function searchGetAsync($query)
    {
        return $this->searchGetAsyncWithHttpInfo($query)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchGetAsyncWithHttpInfo($query)
    {
        $returnType = 'object';
        $request = $this->searchGetRequest($query);
     ...
     */
    protected function searchGetRequest($query)
    {
