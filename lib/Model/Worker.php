...
class Worker implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'messages' => '\Swagger\Client\Model\WorkerMessage[]',
        'commands' => 'object[]',
        'benchmark_id' => 'int',
    ...
    protected static $setters = [
        ...
        'oc_algo' => 'setOcAlgo',
        'oc_algo_actual' => 'setOcAlgoActual',
        'oc_algo_resolved' => 'setOcAlgoResolved',
    ...
    protected static $getters = [
        ...
        'oc_algo' => 'getOcAlgo',
        'oc_algo_actual' => 'getOcAlgoActual',
        'oc_algo_resolved' => 'getOcAlgoResolved',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['oc_algo_actual'] = isset($data['oc_algo_actual']) ? $data['oc_algo_actual'] : null;
        $this->container['oc_algo_resolved'] = isset($data['oc_algo_resolved']) ? $data['oc_algo_resolved'] : null;
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Worker., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Worker., must be smaller than or equal to 255.');
        }
    ...
    public function setUnitsCount($units_count)
    {
        ...
        if (!is_null($units_count) && ($units_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $units_count when calling Worker., must be bigger than or equal to 1.');
        }
    ...
    public function setPassword($password)
    {
        if (!is_null($password) && (mb_strlen($password) > 64)) {
            throw new \InvalidArgumentException('invalid length for $password when calling Worker., must be smaller than or equal to 64.');
        }
        if (!is_null($password) && (mb_strlen($password) < 6)) {
            throw new \InvalidArgumentException('invalid length for $password when calling Worker., must be bigger than or equal to 6.');
        }
     ...
     * Sets oc_id
     *
     * @param int $oc_id ID of recently applied Overclocking profile
     *
     * @return $this
     */
     ...
     * @return string
     */
    public function getOcAlgoActual()
    {
        return $this->container['oc_algo_actual'];
    }

    /**
     * Sets oc_algo_actual
     *
     * @param string $oc_algo_actual Actual algorithm name for which overclock is applied. It is either manually defined or automatically resolved.
     *
     * @return $this
     */
    public function setOcAlgoActual($oc_algo_actual)
    {
        $this->container['oc_algo_actual'] = $oc_algo_actual;

        return $this;
    }

    /**
     * Gets oc_algo_resolved
     *
     * @return string
     */
    public function getOcAlgoResolved()
    {
        return $this->container['oc_algo_resolved'];
    }

    /**
     * Sets oc_algo_resolved
     *
     * @param string $oc_algo_resolved Resolved overclock algorithm name based on applied flight sheet and tuning. This property just indicates which overclock should be applied. See \"oc_algo_actual\" for which is actually applied.
     *
     * @return $this
     */
    public function setOcAlgoResolved($oc_algo_resolved)
    {
        $this->container['oc_algo_resolved'] = $oc_algo_resolved;
     ...
     * Gets messages
     *
     * @return \Swagger\Client\Model\WorkerMessage[]
     */
     ...
     * Sets messages
     *
     * @param \Swagger\Client\Model\WorkerMessage[] $messages Worker messages
     *
     * @return $this
     */
