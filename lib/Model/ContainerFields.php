...
/**
 * ContainerFields Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ContainerFields implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContainerFields';
    ...
    public function setRows($rows)
    {
        ...
        if (!is_null($rows) && ($rows < 1)) {
            throw new \InvalidArgumentException('invalid value for $rows when calling ContainerFields., must be bigger than or equal to 1.');
        }
    ...
    public function setCols($cols)
    {
        ...
        if (!is_null($cols) && ($cols < 1)) {
            throw new \InvalidArgumentException('invalid value for $cols when calling ContainerFields., must be bigger than or equal to 1.');
        }
