...
/**
 * WalletCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WalletCreateRequest extends WalletCoin 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WalletCreateRequest';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WalletCreateRequest., must be smaller than or equal to 100.');
        }
    ...
    public function setWal($wal)
    {
        if (!is_null($wal) && (mb_strlen($wal) > 255)) {
            throw new \InvalidArgumentException('invalid length for $wal when calling WalletCreateRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setSource($source)
    {
        if (!is_null($source) && (mb_strlen($source) > 100)) {
            throw new \InvalidArgumentException('invalid length for $source when calling WalletCreateRequest., must be smaller than or equal to 100.');
        }
